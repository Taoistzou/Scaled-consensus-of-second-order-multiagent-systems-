...
xlabel('s','interpreter','latex','FontSize',18);ylabel('$x_i-\frac{s_1}{s_1}x_1,i=2,3,4,5,6$','interpreter','latex','FontSize',18);
grid on
% 
figure(2)
...
xlabel('s','interpreter','latex','FontSize',18);ylabel('$v_i-\frac{s_1}{s_1}v_1,i=2,3,4,5,6$','interpreter','latex','FontSize',18);
grid on
